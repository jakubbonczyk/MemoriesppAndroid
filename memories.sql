...
CREATE TABLE IF NOT EXISTS `memories`.`grades` (
  ...
  CONSTRAINT `fk_grates_users1`
    FOREIGN KEY (`users_idstudent`)
    REFERENCES `memories`.`users` (`idusers`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_grates_users2`
    FOREIGN KEY (`users_idteacher`)
    REFERENCES `memories`.`users` (`idusers`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_grates_class1`
    FOREIGN KEY (`class_idclass`)
    REFERENCES `memories`.`class` (`idclass`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `memories`.`schedule` (
  ...
  CONSTRAINT `fk_schedule_class1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_schedule_groups1`
    FOREIGN KEY (`groups_idgroups`)
    REFERENCES `memories`.`groups` (`idgroups`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
